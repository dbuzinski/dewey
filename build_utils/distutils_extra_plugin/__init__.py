...
def initialize_distutils_plugin(project):
    ...
    project.set_property_if_unset("distutils_extra_dependencies", {})
...
def render_setup_script(project):
    ...
    template_values = {
        ...
        "extra_dependencies": build_extra_dependencies_string(project),
...
def build_extra_dependencies_string(project):
    return build_map_string(project.get_property('distutils_extra_dependencies'))
